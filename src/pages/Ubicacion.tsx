...
import alicanteSanFernando from '@/assets/images/alicante-san-fernando.jpg';
    ...
    <Layout>
      ...
      <section className="relative min-h-[50vh] flex items-center">
        <div className="absolute inset-0 z-0">
          <img
            src={alicanteSanFernando}
            alt="Vista de Alicante con el Castillo de Santa Bárbara"
            className="w-full h-full object-cover"
          />
          <div className="absolute inset-0 bg-foreground/40" />
        </div>
        <div className="container-coalte relative z-10 text-center">
          <h1 className="heading-display text-primary-foreground mb-4">Ubicación</h1>
          <p className="text-body-lg text-primary-foreground/90 max-w-2xl mx-auto">
            En el corazón de Alicante, bajo el Castillo de San Fernando, 
            perfectamente comunicado y rodeado de servicios.
          </p>
        </div>
      </section>
